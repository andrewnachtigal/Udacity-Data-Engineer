...
songplay_table_create = ("""
    CREATE TABLE IF NOT EXISTS songplays (
        songplay_id TEXT NOT NULL PRIMARY KEY SORTKEY,
        start_time timestamp NOT NULL,
        user_id VARCHAR(500) NOT NULL REFERENCES users(user_id) DISTKEY,
        level VARCHAR(500) NOT NULL,
        song_id VARCHAR(500) REFERENCES songs(song_id),
        artist_id VARCHAR(500) REFERENCES artists(artist_id),
...
user_table_create = ("""
    CREATE TABLE IF NOT EXISTS users (
        user_id VARCHAR(500) NOT NULL PRIMARY KEY SORTKEY,
...
song_table_create = ("""
    CREATE TABLE IF NOT EXISTS songs (
        song_id VARCHAR(500) NOT NULL PRIMARY KEY SORTKEY,
        title VARCHAR(500),
...
songplay_table_insert = ("""
    ...
    SELECT DISTINCT
            md5(se.sessionId || se.start_time) AS songplay_id,
